...
223 words. Infinite expression. Learn to express any idea in Japanese with the minimum vocabulary.

Live at [minihongo.com](https://minihongo.com)

## Goals

- **Make Japanese accessible to everyone.** Even extremely busy people or those with cognitive disabilities can learn 223 words. That is enough to express any idea.
...
| Lesson | What |
|--------|------|
| Vocabulary | 223 core words by category |
...
- **ミニ本語** - Everything built from the 223 base words, with furigana
...
| `minihongo-mh.apkg` | Minihongo (definitions in the 223 base words) |
...
- **Vocabulary** (223 words x 2 = 446 cards) - Recognition (JP -> translation) and Recall (translation -> JP), grouped by category
...
This repo includes a `/minihongo` skill for [Claude Code](https://claude.com/claude-code). It makes the AI speak entirely in Minihongo - built from the 223 base words, with furigana.
