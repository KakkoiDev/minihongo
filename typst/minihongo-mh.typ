...
#block(inset: (top: 0.1em, bottom: 0.1em))[*B:* はい、#ruby[ある][歩]いて#ruby[い][行]けます。#ruby[とお][遠]いですが、#ruby[よ][良]い#ruby[みち][道]です。]
...
=== #ruby[からだ][体]と#ruby[たす][助]ける

#dialog-block[#ruby[からだ][体]が#ruby[わる][悪]い#ruby[とき][時]][#block(inset: (top: 0.1em, bottom: 0.1em))[*#ruby[わたし][私]:* すみません。#ruby[からだ][体]が#ruby[わる][悪]いです。]
...
#block(inset: (top: 0.1em, bottom: 0.1em))[*#ruby[わたし][私]:* #ruby[わ][分]かりました。ありがとうございます。]][#none]

#dialog-block[#ruby[からだ][体]を#ruby[よ][良]くする#ruby[もの][物]を#ruby[か][買]う][#block(inset: (top: 0.1em, bottom: 0.1em))[*#ruby[わたし][私]:* すみません。#ruby[からだ][体]を#ruby[よ][良]くする#ruby[もの][物]が#ruby[ほ][欲]しいです。]
#block(inset: (top: 0.1em, bottom: 0.1em))[*#ruby[か][買]う#ruby[ところ][所]の#ruby[ひと][人]:* どこが#ruby[わる][悪]いですか。]
...
#block(inset: (top: 0.1em, bottom: 0.1em))[*#ruby[か][買]う#ruby[ところ][所]の#ruby[ひと][人]:* #ruby[た][食]べ#ruby[もの][物]で#ruby[からだ][体]が#ruby[わる][悪]くなる#ruby[こと][事]はありますか。]
#block(inset: (top: 0.1em, bottom: 0.1em))[*#ruby[わたし][私]:* いいえ、ないです。]
#block(inset: (top: 0.1em, bottom: 0.1em))[*#ruby[か][買]う#ruby[ところ][所]の#ruby[ひと][人]:* これが#ruby[よ][良]いと#ruby[おも][思]います。#ruby[まい][毎]#ruby[にち][日]、#ruby[た][食]べた#ruby[あと][後]に#ruby[ひと][一]つ#ruby[の][飲]んでください。]
#block(inset: (top: 0.1em, bottom: 0.1em))[*#ruby[わたし][私]:* #ruby[わ][分]かりました。いくらですか。]
#block(inset: (top: 0.1em, bottom: 0.1em))[*#ruby[か][買]う#ruby[ところ][所]の#ruby[ひと][人]:* #ruby[ご][五]#ruby[ひゃく][百]です。#ruby[よ][良]くならないなら、#ruby[からだ][体]を#ruby[たす][助]ける#ruby[ひと][人]に#ruby[あ][会]ってください。]][#none]

#dialog-block[#ruby[たす][助]けてください][#block(inset: (top: 0.1em, bottom: 0.1em))[*A:* すみません！#ruby[たす][助]けてください！]
...
#block(inset: (top: 0.1em, bottom: 0.1em))[*B:* はい。#ruby[みず][水]を#ruby[あた][与]えましょう。#ruby[からだ][体]を#ruby[うご][動]かさないでください。]][#none]

=== #ruby[ところ][所]で#ruby[はな][話]す

#dialog-block[#ruby[ひと][人]が#ruby[く][来]る#ruby[もの][物]を#ruby[ま][待]つ#ruby[ところ][所]で][#block(inset: (top: 0.1em, bottom: 0.1em))[*A:* すみません。ここから#ruby[うみ][海]の#ruby[ひと][人]が#ruby[く][来]る#ruby[もの][物]を#ruby[ま][待]つ#ruby[ところ][所]まで#ruby[い][行]きたいです。]
...
#block(inset: (top: 0.1em, bottom: 0.1em))[*#ruby[ところ][所]の#ruby[ひと][人]:* #ruby[に][二]#ruby[じゅう][十]ぐらいです。#ruby[みっ][三]つ#ruby[め][目]の#ruby[ところ][所]で#ruby[で][出]てください。]][#none]

#dialog-block[#ruby[た][食]べる#ruby[ところ][所]で][#block(inset: (top: 0.1em, bottom: 0.1em))[*#ruby[か][買]う#ruby[ところ][所]の#ruby[ひと][人]:* #ruby[なん][何]#ruby[にん][人]ですか。]
#block(inset: (top: 0.1em, bottom: 0.1em))[*A:* #ruby[ふた][二]りの#ruby[ひと][人]です。]
#block(inset: (top: 0.1em, bottom: 0.1em))[*#ruby[か][買]う#ruby[ところ][所]の#ruby[ひと][人]:* どうぞ、こちらに#ruby[すわ][座]ってください。]
#block(inset: (top: 0.1em, bottom: 0.1em))[*A:* すみません。この#ruby[た][食]べ#ruby[もの][物]の#ruby[なか][中]に#ruby[なに][何]がありますか。]
#block(inset: (top: 0.1em, bottom: 0.1em))[*#ruby[か][買]う#ruby[ところ][所]の#ruby[ひと][人]:* #ruby[くさ][草]と#ruby[にく][肉]です。#ruby[からだ][体]が#ruby[わる][悪]くなる#ruby[た][食]べ#ruby[もの][物]はありますか。]
#block(inset: (top: 0.1em, bottom: 0.1em))[*A:* はい。#ruby[たまご][卵]で#ruby[からだ][体]が#ruby[わる][悪]くなります。]
#block(inset: (top: 0.1em, bottom: 0.1em))[*#ruby[か][買]う#ruby[ところ][所]の#ruby[ひと][人]:* #ruby[わ][分]かりました。この#ruby[た][食]べ#ruby[もの][物]には#ruby[たまご][卵]は#ruby[はい][入]っていません。]
#block(inset: (top: 0.1em, bottom: 0.1em))[*A:* では、これをください。]
#block(inset: (top: 0.1em, bottom: 0.1em))[*A:* すみません。お#ruby[かね][金]を#ruby[ぜんぶ][全部]ください。]][#none]

#dialog-block[#ruby[か][買]う#ruby[ところ][所]で][#block(inset: (top: 0.1em, bottom: 0.1em))[*#ruby[か][買]う#ruby[ところ][所]の#ruby[ひと][人]:* #ruby[き][来]てくれてありがとう。]
#block(inset: (top: 0.1em, bottom: 0.1em))[*A:* すみません。この#ruby[た][食]べ#ruby[もの][物]を#ruby[あつ][暑]くしてください。]
#block(inset: (top: 0.1em, bottom: 0.1em))[*#ruby[か][買]う#ruby[ところ][所]の#ruby[ひと][人]:* はい。#ruby[すこ][少]し#ruby[ま][待]ってください。#ruby[い][入]れる#ruby[もの][物]は#ruby[ひつよう][必要]ですか。]
#block(inset: (top: 0.1em, bottom: 0.1em))[*A:* はい、ください。]
#block(inset: (top: 0.1em, bottom: 0.1em))[*#ruby[か][買]う#ruby[ところ][所]の#ruby[ひと][人]:* #ruby[ほか][他]に#ruby[ほ][欲]しい#ruby[もの][物]はありますか。]
#block(inset: (top: 0.1em, bottom: 0.1em))[*A:* この#ruby[の][飲]み#ruby[もの][物]もください。]
#block(inset: (top: 0.1em, bottom: 0.1em))[*#ruby[か][買]う#ruby[ところ][所]の#ruby[ひと][人]:* #ruby[ぜんぶ][全部]で#ruby[さん][三]#ruby[びゃく][百]#ruby[ご][五]#ruby[じゅう][十]です。]
#block(inset: (top: 0.1em, bottom: 0.1em))[*A:* お#ruby[かね][金]の#ruby[ちい][小]さい#ruby[もの][物]で#ruby[よ][良]いですか。]
#block(inset: (top: 0.1em, bottom: 0.1em))[*#ruby[か][買]う#ruby[ところ][所]の#ruby[ひと][人]:* はい。ありがとうございます。]][#none]

#dialog-block[#ruby[おと][音]で#ruby[い][言]う#ruby[もの][物]で#ruby[ひと][人]に#ruby[い][言]う][#block(inset: (top: 0.1em, bottom: 0.1em))[*A:* もしもし。#ruby[からだ][体]を#ruby[たす][助]ける#ruby[ところ][所]ですか。]
...
#block(inset: (top: 0.1em, bottom: 0.1em))[*#ruby[からだ][体]を#ruby[たす][助]ける#ruby[ところ][所]の#ruby[ひと][人]:* たなかさんですね。#ruby[あと][後]の#ruby[にち][日]の#ruby[じゅう][十]の#ruby[とき][時]です。#ruby[ま][待]っています。]][#none]

#dialog-block[#ruby[き][来]た#ruby[こと][事]を#ruby[か][書]く#ruby[ところ][所]をする#ruby[ところ][所]で][#block(inset: (top: 0.1em, bottom: 0.1em))[*A:* すみません。ここに#ruby[き][来]た#ruby[こと][事]を#ruby[か][書]きたいです。]
...
#block(inset: (top: 0.1em, bottom: 0.1em))[*#ruby[ところ][所]の#ruby[ひと][人]:* #ruby[ふた][二]つ#ruby[め][目]の#ruby[ところ][所]に#ruby[も][持]って#ruby[い][行]ってください。]][#none]

=== #ruby[ひと][人]と#ruby[ひと][人]

#dialog-block[#ruby[わたし][私]の#ruby[こと][事]を#ruby[い][言]う][#block(inset: (top: 0.1em, bottom: 0.1em))[*A:* こんにちは。ここに#ruby[あたら][新]しく#ruby[き][来]ました。#ruby[わたし][私]はたなかです。]
...
#block(inset: (top: 0.1em, bottom: 0.1em))[*A:* ありがとうございます。とても#ruby[たす][助]かります。]][#none]

#dialog-block[もう#ruby[ひと][一]つください][#block(inset: (top: 0.1em, bottom: 0.1em))[*A:* すみません。#ruby[いま][今]の#ruby[ことば][言葉]が#ruby[わ][分]かりませんでした。]
...
#block(inset: (top: 0.1em, bottom: 0.1em))[*A:* はい！#ruby[か][書]いた#ruby[もの][物]は#ruby[わ][分]かります。ありがとうございます。]][#none]

#dialog-block[#ruby[いえ][家]が#ruby[ちか][近]い#ruby[ひと][人]][#block(inset: (top: 0.1em, bottom: 0.1em))[*A:* すみません。この#ruby[もの][物]は#ruby[いま][今]の#ruby[にち][日]に#ruby[そと][外]に#ruby[だ][出]してもいいですか。]
...
#block(inset: (top: 0.1em, bottom: 0.1em))[*B:* #ruby[わ][分]からない#ruby[こと][事]があったら、#ruby[き][聞]いてください。]][#none]

#dialog-block[#ruby[そら][空]の#ruby[こと][事]の#ruby[はなし][話]][#block(inset: (top: 0.1em, bottom: 0.1em))[*A:* #ruby[いま][今]の#ruby[にち][日]は#ruby[そら][空]がとてもきれいですね。]
...
#block(inset: (top: 0.1em, bottom: 0.1em))[*A:* #ruby[よ][良]いですね。#ruby[よ][良]い#ruby[にち][日]にしましょう。]][#none]
...
#block(inset: (top: 0.15em, bottom: 0.15em))[その#ruby[とき][時]、#ruby[ちい][小]さい#ruby[とり][鳥]が#ruby[ひと][一]つ、#ruby[き][木]の#ruby[した][下]に#ruby[き][来]た。]
